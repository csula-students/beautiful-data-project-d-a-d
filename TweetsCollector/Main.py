...
def main():
    ...
    print "Started at: ", time.strftime("%I:%M:%S %p")
    ...
    for day in range(10, 31):
        start = time.time()
        date1 = "2016-05-" + str(day)
        date2 = "2016-05-" + str(day + 1)
        ...
        for tweet in tweets:
            insert = db.tweets_may.insert_one({
        ...
        print "Inserted day", date1, "through", date2 + ".", "Time Elapsed:", elapsed, "Cuurent Time:", time.strftime("%I:%M:%S %p")
